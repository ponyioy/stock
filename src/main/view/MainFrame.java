...
//		};
		...
		stockWatchTable.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				 int currentRow = stockWatchTable.convertRowIndexToModel(stockWatchTable.getSelectedRow());
				currentStockCode = (String) stockWatchTable.getModel().getValueAt(currentRow, 0);
				updateImageForStock();
				updateHandicapForStock(stockDatas.get(currentStockCode));
			}
		});
